...
export default function LoginButton() {
    ...
    return (
        <button
            onClick={handleLogin}
            disabled={isLoading}
            className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-[24px] bg-white px-8 py-5 font-black text-black shadow-[0_20px_40px_-10px_rgba(255,255,255,0.1)] transition-all hover:scale-[1.02] hover:shadow-[0_20px_40px_-10px_rgba(74,17,23,0.3)] active:scale-95 disabled:opacity-50 disabled:grayscale transition-duration-500"
        >
            {isLoading ? (

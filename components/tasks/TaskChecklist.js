        ...
        <div className="space-y-4">
                    ...
                    items.map((item) => (
                        <div 
                            ...
                            className={`flex items-center justify-between p-3 rounded-xl border transition-all ${
                                item.checked ? 'bg-emerald-500/5 border-emerald-500/10' : 'bg-background border-card-border hover:border-brand-accent/30'
                            }`}
                        >
                            <div 
            ...
            <form onSubmit={handleAdd} className="flex gap-2">
                <input 
                    ...
                    className="flex-1 bg-accent-slate/50 border border-card-border rounded-xl px-4 py-2.5 text-xs font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-brand-accent/20 focus:border-brand-accent transition-all"
                />
                <button 
                    type="submit"
                    className="p-2.5 bg-brand-accent text-background rounded-xl hover:scale-[1.05] active:scale-95 transition-all shadow-lg shadow-brand-accent/20"
                >
                    <Plus size={18} />
                </button>
            </form>
